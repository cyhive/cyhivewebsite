...
const VerifyCourse = () => {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.get(`http://localhost:5000/api/verify/course/${courseId}`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <HeroBanner
        title="Verify Course"
        subtitle="Validate your CYHIVE course certificate"
          ...
          <div className="max-w-xl mx-auto">
            <Card className="shadow-lg border-t-4 border-t-cyhive-500">
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle className="text-3xl font-bold">Course Certificate</CardTitle>
                <CardDescription className="text-base pt-2">
                  Please enter your unique course completion ID to view and verify your certificate details.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {certificateData ? (
                  ...
                  <form onSubmit={handleVerify} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="courseId" className="text-base font-medium">
                        Course Completed ID
                      </Label>
                      <Input
                        id="courseId"
                        type="text"
                        placeholder="e.g., CY-CRS-2024-XXXX"
                        value={courseId}
              ...
              <CardFooter className="flex justify-center border-t mt-6 pt-6 text-sm text-gray-500 text-center">
                If you have trouble finding your course ID, please check the email you received upon completion or contact support.
              </CardFooter>
            </Card>
          </div>
        </div>
